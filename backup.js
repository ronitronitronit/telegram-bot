...
app.post("/new-message", function(req, res) {
  ...
  if (message.text.toLowerCase().indexOf("bot") < 0) {
    ...
    axios
      .post(
        "https://api.telegram.org/bot541004292:AAGPoQiWS8pQTOYR9wND_TUrfQl8Q2obFC0/sendMessage",
        {
          chat_id: message.chat.id,
          text:
            "Here you go: https://docs.google.com/spreadsheets/d/16BueSIDpsdKJoQVQNJM-mYfM-1CWogEJ-ugm5e6a31A/edit#gid=0"
        }
      )
      .then(response => {
